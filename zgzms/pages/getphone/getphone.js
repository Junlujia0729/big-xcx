...
Page({
  ...
  get_mobile_code: function () {
    ...
    userApi.requestAppApi_POST(app.globalData.mainDomain + "XcxApi/matrix_sms", {
  ...
  checkmobile: function (e) {
    ...
    userApi.requestAppApi_POST(app.globalData.mainDomain + "XcxApi/matrix_setUserInputPhone", {
