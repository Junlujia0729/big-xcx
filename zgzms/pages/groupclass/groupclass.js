...
Page({
  ...
  onLoad: function (options) {
    ...
    userApi.xcx_login_new(1, 0, function () {
      userApi.requestAppApi_POST(app.globalData.mainDomain + "Course/group_detail",
      ...
      userApi.requestAppApi_POST(app.globalData.mainDomain + "Course/rec_class", { groupid: options.groupid }, function (res) {
        console.log(res.data.data);
        that.setData({
          items: res.data.data
        });
